...
public class TimeTest2
{
    ...
    {
        File file = new File("/Users/airtium/IdeaProjects/hse_java/src/hundred_thousand.txt");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("Time for _sum: " +  TimeTest2.TimeSum());
        System.out.println("Time for _mult: " +  TimeTest2.TimeMult());
        System.out.println("Time for _max: " +  TimeTest2.TimeMax());
        System.out.println("Time for _min: " +  TimeTest2.TimeMin());
    }
}
