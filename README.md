...
В данном пункте представлен график зависимости выполнения функции _min в зависимости от количества чисел в файле (1000, 10000 и 100000 соответственно:
![Зависимость](Зависимость.png)
...
Данный пункт выполнен, добавлена CI-система с возможностью ручного запуска тестов и запуска тестов при каждом коммите
## Настройте CI таким образом, чтобы прогон тестов запускался автоматически при любом новом коммите в репозиторий вашего проекта
Указано выше, данное условие выполнено
